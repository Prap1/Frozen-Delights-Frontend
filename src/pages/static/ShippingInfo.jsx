        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden p-8">
                ...
                <div className="prose prose-blue text-gray-600">
                    <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Why does the delivery date not correspond to the delivery timeline of X-Y business days?</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">What is the estimated delivery time?</h3>
                    <p className="mb-2">
                    ...
                    <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Why does the estimated delivery time vary for each seller?</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Seller does not/cannot ship to my area. Why?</h3>
                    <p className="mb-4">
