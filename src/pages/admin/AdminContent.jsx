...
const AdminContent = () => {
    ...
    <div>
        ...
        <p className="text-gray-600 mt-1 sm:mt-2">
            Manage announcements, and site content.
        </p>
    </div>
    ...
    <div className="flex flex-col gap-2 sm:flex-row sm:gap-2 w-full sm:w-auto">
        ...
        <button
            onClick={async () => {
                ...
                const defaultPolicies = [
                    { type: 'privacy', title: 'Privacy Policy', content: 'We value the trust you place in us...', isActive: true },
                    { type: 'terms', title: 'Terms of Service', content: 'TERMS OF SERVICE...', isActive: true },
                ];
        ...
        >
            <FaPlus />
            Add New {activeTab === 'policies' ? 'Policy' : 'Content'}
        </button>
    </div>
</div>
